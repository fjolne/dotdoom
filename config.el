...
(map! (:after smartparens
       ...
       :mi "C-M-<right>"   #'sp-next-sexp
       :mi "C-M-<left>"    #'sp-backward-sexp
       :mi "C-M-S-<down>"  #'sp-next-sexp
       :mi "C-M-S-<up>"    #'sp-previous-sexp
...
(map!
 :n "C-y" #'evil-scroll-up
 :n "C-u" #'evil-scroll-down
 :n "C-," #'evil-scroll-line-down
 :n "C-." #'evil-scroll-line-up)
